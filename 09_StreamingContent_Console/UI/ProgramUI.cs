 ...
 public class ProgramUI
    {
        ...
        private readonly StreamingRepository _streamingRepo = new StreamingRepository(); //this is a field
        ...
        private void ShowContentByTitle()
        {
            ...
            {
                _console.WriteLine("Invalid title. Could not find any result.");
            }
            _console.WriteLine("Press any key to continue.");
            _console.ReadKey();
        }
        private void RemoveContentFromList()
        {
            ...
            if(targetIndex >= 0 && targetIndex < contentList.Count)
            {
                ...
                {
                    _console.WriteLine($"{desiredContent.Title} successfully remove.");
                }
                else
                {
        ...
        private void DisplayContent (StreamingContent content) //writing this method to make our code a little easier. so we aren't writing the same thing over and over
        {
